...
(defn test-helper [code]
  ...
  (let [res (sut/read-prolog-code-as-raw-edn "swipl" "prolog/prolog_analyzer.pl" "swipl" "prolog/tmp.pl")]
...
(deftest process-files:preds
  (let [result (sut/process-prolog-file "swipl" "prolog/prolog_analyzer.pl" "swipl" "resources/spec-test.pl")]
