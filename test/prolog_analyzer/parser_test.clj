...
(facts
 (fact "About Post Specs"
       ...
       =>
       (contains {["simple_example" "a" 1]    [[[{:id 0 :type (r/->AnySpec)}]
                                                [[{:id 0 :type (r/->AtomSpec)}]]]]
                  ["simple_example" "foo" 2]  [[[{:id 0 :type (r/->AnySpec)} {:id 1 :type (r/->AnySpec)}]
                                                [[{:id 0 :type (r/->IntegerSpec)} {:id 1 :type (r/->IntegerSpec)}] [{:id 0 :type (r/->AtomSpec)} {:id 1 :type (r/->AtomSpec)}]]]]}))
