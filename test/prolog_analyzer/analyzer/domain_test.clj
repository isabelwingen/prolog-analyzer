...
(deftest fill-env-for-term-with-spec-test-list
  (are [term]
      (= [{:spec :list :type {:spec :integer}}] (utils/get-dom-of-term (sut/fill-env-for-term-with-spec2 test-env term {:spec :list :type {:spec :integer}}) term))
  ...
  (are [term]
      (false? (utils/valid-env? (sut/fill-env-for-term-with-spec2 test-env term {:spec :list :type {:spec :integer}})))
...
(deftest fill-env-for-term-with-spec-test-tuple
  (are [term]
      (= [{:spec :tuple :arglist [{:spec :integer} {:spec :atom}]}] (utils/get-dom-of-term (sut/fill-env-for-term-with-spec2 test-env term {:spec :tuple :arglist [{:spec :integer} {:spec :atom}]}) term))
  ...
  (are [term]
      (false? (utils/valid-env? (sut/fill-env-for-term-with-spec2 test-env term {:spec :tuple :arglist [{:spec :integer} {:spec :atom}]})))
    {:type :atomic :term "[]"}
    {:type :list :head {:type :float :value 2.5} :tail {:type :atomic :term "[]"}} ;TODO: atm the error is only visible in the HEAD term. Should it be at top level?
    {:type :compound :functor "foo" :arglist [{:spec :atom :term "foo"}]}
    {:type :atom :term "nocake"}
...
(deftest fill-env-for-term-with-spec-test-compound
  (are [term]
      (= [{:spec :compound :functor "foo" :arglist [{:spec :integer} {:spec :atom}]}] (utils/get-dom-of-term (sut/fill-env-for-term-with-spec2 test-env term {:spec :compound :functor "foo" :arglist [{:spec :integer} {:spec :atom}]}) term))
  ...
  (are [term]
      (false? (utils/valid-env? (sut/fill-env-for-term-with-spec2 test-env term {:spec :compound :functor "fooy" :arglist [{:spec :integer} {:spec :atom}]})))
    {:type :atomic :term "[]"}
    {:type :list :head {:type :float :value 2.5} :tail {:type :atomic :term "[]"}} ;TODO: atm the error is only visible in the HEAD term. Should it be at top level?
    {:type :compound :functor "foo" :arglist [{:spec :atom :term "foo"}]}
